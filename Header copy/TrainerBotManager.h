...
public:
    // These values used to be in the source file like this : #define PI 3.141592. We changed them to const double PI = 3.141592; to respect the C++ standard and to be able to change them when we use different robots
    // The physical values are corresponding to the robot we used for the project. If you use another robot, you will have to change these values. The robot of the project is the yellow one.
    double PI = 3.141592;
    ...
    int Rg = 0; // Either 1 or 2 wether we use clutch for high speed or for low speed
    ...
    void PutOnTheClutch();
    double GetWeightToApply(double currentLength);
