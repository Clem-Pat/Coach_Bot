...
void Trapezoid::Begin() {
    vertices[0] = { 0.0 * TheTrainerApp->TheTrainer->MaximumLengthPulledByUser, 0.0 * TheTrainerApp->TheTrainer->botManager.InputMotorTorque };
    vertices[1] = { 0.2 * TheTrainerApp->TheTrainer->MaximumLengthPulledByUser, 1.0 * TheTrainerApp->TheTrainer->botManager.InputMotorTorque };
    vertices[2] = { 0.5 * TheTrainerApp->TheTrainer->MaximumLengthPulledByUser, 1.0 * TheTrainerApp->TheTrainer->botManager.InputMotorTorque };
    vertices[3] = { 1.0 * TheTrainerApp->TheTrainer->MaximumLengthPulledByUser, 0.0 * TheTrainerApp->TheTrainer->botManager.InputMotorTorque };
}
...
void Trapezoid::update() {
    ...
    for (int k = 0; k < vertices.size(); ++k) {
        vertices[k][1] = vertices[k][1] * TheTrainerApp->TheTrainer->botManager.InputMotorTorque / *maxYValue;
    }
}
