...
void TrainerBotManager::BotCommand() {
    ...
    if (Rg == 2) {
        AnalogOutput[0] = (int)(190 * MotorTorque[0]) + 32768; // �� ���[�^�d��[V] 115.89
        AnalogOutput[1] = -(int)(125.97 * MotorTorque[1]) + 32768; // �� ���[�^�d��[V] 125.97
    }
    else if (Rg == 1) {
        AnalogOutput[0] = (int)(100 * (MotorTorque[0] - 5)) + 32768; // �� ���[�^�d��[V]���� 60.416
        AnalogOutput[1] = -(int)(62.789 * (MotorTorque[1] - 5)) + 32768; // �� ���[�^�d��[V]���� 62.789
    }
