...
public:
    ...
    int PotentiometerCounter[2] = { 0, 0 };
    float PotentiometerOrigin[2];
    float PrePotentiometerRelativeValue[2] = { 0, 0 };
    float AngleRelativeValue[2];
    float DistanceRelativeValue[2];
